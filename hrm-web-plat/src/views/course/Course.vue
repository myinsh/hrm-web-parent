<template>
    <section>
        ...
        <el-table :data="courses" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
            ...
            <el-table-column prop="startTime" label="上线时间" width="180" sortable :formatter="formatStartTime" align="center">
            </el-table-column>
            <el-table-column prop="endTime" label="下线时间" width="180" sortable :formatter="formatEndTime" align="center">
            </el-table-column>
            ...
            <el-table-column label="操作" width="300" fixed="right" align="center">
                <template scope="scope">
                    ...
                    <el-button type="danger" size="small" @click="handleEdit(scope.$index, scope.row)">基本信息</el-button>
                    <el-button type="default" size="small" @click="handleEdit(scope.$index, scope.row)">资源信息</el-button>
                </template>
            </el-table-column>
        </el-table>
